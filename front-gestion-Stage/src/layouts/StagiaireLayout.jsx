...
export default function StagiaireLayout() {
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-emerald-50 via-blue-50 to-cyan-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 text-gray-800 dark:text-gray-100">
      {/* Sidebar */}
      <StagiaireSidebar
        collapsed={collapsed}
