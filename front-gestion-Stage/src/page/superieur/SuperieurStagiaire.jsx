...
// Données de démonstration consolidées pour tous les stagiaires
const stagiairesData = [
  ...
  },
  {
    ...
    formation: "Mobile Development",
    entreprise: "AppFactory",
    ...
    ville: "Nantes",
    encadreur: "Sophie Martin",
    specialite: "React Native, Flutter, iOS/Android",
    note: 16,
    dernierRapport: "2024-12-02"
  },
  {
    id: 8,
    nom: "Roux",
    ...
    ville: "Strasbourg",
    encadreur: "Pierre Bernard",
    specialite: "Power BI, SQL, Data Modeling",
    note: 19,
    dernierRapport: "2024-12-08"
  }
];
...
export default function SuperieurStagiaire() {
  ...
  const encadreurs = [...new Set(stagiaires.map(s => s.encadreur))];
  ...
  const stagiairesFiltres = stagiaires.filter(stagiaire => {
    const correspondRecherche = 
      ...
      stagiaire.encadreur.toLowerCase().includes(recherche.toLowerCase());
    
    const correspondStatut = filtreStatut === "tous" || stagiaire.statut === filtreStatut;
    const correspondEncadreur = filtreEncadreur === "tous" || stagiaire.encadreur === filtreEncadreur;
  ...
  const stats = {
    ...
    moyenneNotes: Math.round(stagiaires.reduce((acc, s) => acc + (s.note || 0), 0) / stagiaires.length),
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-between">
              <div className="flex flex-col sm:flex-row gap-4 flex-1 w-full">
                ...
                <div className="relative flex-1 max-w-md">
                  ...
                  <Input
                    placeholder="Rechercher un stagiaire, formation, entreprise ou encadreur..."
                    value={recherche}
          ...
          {stagiairesFiltres.map((stagiaire) => (
            ...
            >
              <Card className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border border-white/20 dark:border-gray-700/50 shadow-xl hover:shadow-2xl transition-all duration-300 rounded-2xl overflow-hidden h-full">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          ...
                          {stagiaire.note && (
                            <Badge className={`text-xs ${getNoteColor(stagiaire.note)}`}>
                              {stagiaire.note}/20
                            </Badge>
                          )}
                        </div>
                ...
                {/* Dernier rapport */}
                {stagiaire.dernierRapport && (
                  <div className="px-6 pb-4">
                    <div className="text-xs text-gray-500 dark:text-gray-400 mb-1">Dernier rapport</div>
                    <div className="text-sm text-gray-700 dark:text-gray-300">
                      {new Date(stagiaire.dernierRapport).toLocaleDateString()}
                    </div>
                  </div>
                )}
                ...
                <div className="p-6 pt-4 border-t border-gray-100 dark:border-gray-700/50 bg-gray-50/50 dark:bg-gray-700/30">
                  <div className="flex gap-2">
                    ...
                    <Button
                      ...
                      size="sm"
                      className="gap-2 border-gray-300 dark:border-gray-600"
                      onClick={() => handleContacterEncadreur(stagiaire.encadreur)}
